...
if has_lightgbm:
    class LightGBMModel(BaseModel):
        ...
        def __init__(self, name: str = "LightGBM", multi_output: bool = True, n_estimators: int = 100, **kwargs):
            """
            初始化LightGBM回归模型
            ...
            **kwargs : dict
            ...
            # 创建基础模型
            base_model = LGBMRegressor(n_estimators=n_estimators, **kwargs)
